 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var P = "cancelled", F = "unknown", V = "invalid-argument", O = "deadline-exceeded", N = "not-found", D = "permission-denied", q = "unauthenticated", R = "resource-exhausted", x = "failed-precondition", C = "aborted", L = "out-of-range", j = "unimplemented", M = "internal", U = "unavailable", B = /** @class */ function(e) {
    /** @hideconstructor */
    function n(
    /**
...
var ye = /** @class */ function() {
    ...
    this.startAt = o, this.endAt = a, this.O = null;
};
...
/** Used to represent a field transform on a mutation. */ var Oe = function() {
    ...
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).serializer = t, r.L = n, r;
    }
    return t(n, e), n;
}(Oe), xe = function(t, e) {
...
}(), Le = function() {}, je = /** @class */ function(e) {
    function n(t, n, r, i) {
        void 0 === i && (i = []);
        var o = this;
...
function Ze(t, e) {
    ...
    if (n.get(1) !== t.databaseId.projectId) throw new B(V, "Tried to deserialize key from different project: " + n.get(1) + " vs " + t.databaseId.projectId);
    if (n.get(3) !== t.databaseId.database) throw new B(V, "Tried to deserialize key from different database: " + n.get(3) + " vs " + t.databaseId.database);
...
function rn(t, e) {
    ...
    var i = function(t) {
        if (0 !== t.length) return cn(Zt.create(t, "and" /* CompositeOperator.AND */));
    }(e.filters);
 ...
 */ var pn = /** @class */ function() {
     ...
     */ , i) {
        ...
        this.M = t, this.timerId = e, this.k = n, this.U = r, this.j = i, this.W = 0, this.K = null, 
    ...
    t.prototype.J = function(t) {
        ...
        // honored as such).
        var n = Math.floor(this.W + this.Y()), r = Math.max(0, Date.now() - this.G), i = Math.max(0, n - r);
        ...
        this.K = this.M.enqueueAfterDelay(this.timerId, i, (function() {
            return e.G = Date.now(), t();
        })), 
    ...
    function n(t, n, r, i) {
        ...
        o.connection = r, o.serializer = i, o.X = !1, o;
    }
    return t(n, e), n.prototype.tt = function() {
        if (this.X) throw new B(x, "The client has already been terminated.");
    }, 
    /** Invokes the provided RPC with auth and AppCheck tokens. */ n.prototype.R = function(t, e, n) {
        ...
        return this.tt(), Promise.all([ this.authCredentials.getToken(), this.appCheckCredentials.getToken() ]).then((function(i) {
            ...
            r.appCheckCredentials.invalidateToken()), t) : new B(F, t.toString());
        }));
    }, 
...
function yn(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return e = A(t), i = en(e.serializer) + "/documents", o = {
                ...
                return a = n.sent(), u = new Map, a.forEach((function(t) {
                    var n = function(t, e) {
                        return "found" in e ? function(t, e) {
                            ...
                            var n = Ze(t, e.found.name), r = Je(e.found.updateTime), i = e.found.createTime ? Je(e.found.createTime) : fe.min(), o = new ge({
                                mapValue: {
                            ...
                            var n = Ze(t, e.missing), r = Je(e.readTime);
 ...
 */ function gn(t) {
    ...
    if (!vn.has(t)) {
        ...
        var e = function(t) {
            ...
            return new $(t, e, n, r.host, r.ssl, r.experimentalForceLongPolling, r.experimentalAutoDetectLongPolling, ft(r.experimentalLongPollingOptions), r.useFetchStreams);
        }(t._databaseId, t.app.options.appId || "", t._persistenceKey, t._freezeSettings())), n = hn(t._databaseId), r = function(t, e, n, r) {
 ...
 */ var wn = /** @class */ function() {
    function t(t) {
        var e, n;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new B(V, "Can't provide ssl option if host option is not set");
        ...
        this.localCache = t.localCache, void 0 === t.cacheSizeBytes) this.cacheSizeBytes = 41943040; else {
            if (-1 !== t.cacheSizeBytes && t.cacheSizeBytes < 1048576) throw new B(V, "cacheSizeBytes must be at least 1048576");
            this.cacheSizeBytes = t.cacheSizeBytes;
        }
        !function(t, e, n, r) {
            if (!0 === e && !0 === r) throw new B(V, "".concat(t, " and ").concat(n, " cannot be used together."));
        ...
        function(t) {
            if (void 0 !== t.timeoutSeconds) {
                if (isNaN(t.timeoutSeconds)) throw new B(V, "invalid long polling timeout: ".concat(t.timeoutSeconds, " (must not be NaN)"));
                if (t.timeoutSeconds < 5) throw new B(V, "invalid long polling timeout: ".concat(t.timeoutSeconds, " (minimum allowed value is 5)"));
                if (t.timeoutSeconds > 30) throw new B(V, "invalid long polling timeout: ".concat(t.timeoutSeconds, " (maximum allowed value is 30)"));
            }
    ...
    return Object.defineProperty(t.prototype, "app", {
        ...
        this._settings = new wn(t), void 0 !== t.credentials && (this._authCredentials = function(t) {
            ...
            switch (t.type) {
              ...
              default:
                throw new B(V, "makeAuthCredentialsProvider failed due to invalid credential type");
            }
        }(t.credentials));
 ...
 */ function En(t, e, n, r) {
    var i;
    void 0 === r && (r = {});
    var o = (t = ct(t, _n))._getSettings(), a = "".concat(e, ":").concat(n);
    ...
    t._setSettings(Object.assign(Object.assign({}, o), {
        ...
        if ("string" == typeof r.mockUserToken) u = r.mockUserToken, s = v.MOCK_USER; else {
            ...
            if (!c) throw new B(V, "mockUserToken must contain 'sub' or 'user_id' field!");
            s = new v(c);
        }
 ...
 */ function Vn(t, e) {
    ...
    if (t = p(t), ot("collection", "path", e), t instanceof _n) {
        ...
        return ut(o), new Fn(t, /* converter= */ null, o);
    }
    if (!(t instanceof Pn || t instanceof Fn)) throw new B(V, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var a = t._path.child(et.fromString.apply(et, r([ e ], n, !1)));
    return ut(a), new Fn(t.firestore, 
    /* converter= */ null, a);
}
...
function Nn(t, e) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = Tt.C()), ot("doc", "path", e), t instanceof _n) {
        var o = et.fromString.apply(et, r([ e ], n, !1));
        return at(o), new Pn(t, 
        /* converter= */ null, new it(o));
    }
    if (!(t instanceof Pn || t instanceof Fn)) throw new B(V, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var a = t._path.child(et.fromString.apply(et, r([ e ], n, !1)));
    return at(a), new Pn(t.firestore, t instanceof Fn ? t.converter : null, new it(a));
}
 ...
 * Firestore database.
 */ function Dn(t, e) {
    return t = p(t), e = p(e), (t instanceof Pn || t instanceof Fn) && (e instanceof Pn || e instanceof Fn) && t.firestore === e.firestore && t.path === e.path && t.converter === e.converter
    /**
...
var Rn = /** @class */ function() {
    ...
    function t() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        for (var n = 0; n < t.length; ++n) if (0 === t[n].length) throw new B(V, "Invalid field name at argument $(i + 1). Field names must not be empty.");
...
function(t) {
     ...
     */
    function t(t, e) {
        if (!isFinite(t) || t < -90 || t > 90) throw new B(V, "Latitude must be a number between -90 and 90, but was: " + t);
        if (!isFinite(e) || e < -180 || e > 180) throw new B(V, "Longitude must be a number between -180 and 180, but was: " + e);
    ...
    return t.prototype.toMutation = function(t, e) {
        return null !== this.fieldMask ? new Me(t, this.data, this.fieldMask, e, this.fieldTransforms) : new je(t, this.data, e, this.fieldTransforms);
    }, t;
}(), Bn = /** @class */ function() {
    function t(t, 
...
/** A "context" object passed around while parsing user data. */ var Kn = /** @class */ function() {
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.it = function(e) {
        ...
        return lr(t, this.settings.methodName, this.settings.ht || !1, this.path, this.settings.dt);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (zn(this.nt) && Mn.test(t)) throw this.ct('Document fields cannot begin and end with "__"');
    }, t;
}(), Gn = /** @class */ function() {
    function t(t, e, n) {
        this.databaseId = t, this.ignoreUndefinedProperties = e, this.serializer = n || hn(t)
...
/** Parse document data from a set() call. */ function Wn(t, e, n, r, i, o) {
    void 0 === o && (o = {});
...
var Yn = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        if (2 /* UserDataSource.MergeSet */ !== t.nt) throw 1 /* UserDataSource.Update */ === t.nt ? t.ct("".concat(this._methodName, "() can only appear at the top level of your update data")) : t.ct("".concat(this._methodName, "() cannot be used with set() unless you pass {merge:true}"));
...
}(Ln), Xn = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t) || this).Et = n, r;
    }
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        var e = Hn(this, t, 
        /*array=*/ !0), n = this.Et.map((function(t) {
            return rr(t, e);
        })), r = new De(n);
...
}(Ln), Zn = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t) || this).At = n, r;
    }
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        var e = new Re(t.serializer, Ve(t.serializer, this.At));
...
/** Parse update data from a list of field/value arguments. */ function er(t, e, n, r, i, o) {
    var a = t.ft(1 /* UserDataSource.Update */ , e, n), u = [ ur(e, r, n) ], s = [ i ];
    ...
    for (var l = [], f = ge.empty(), h = u.length - 1; h >= 0; --h) if (!fr(l, u[h])) {
        var d = u[h], y = s[h];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        y = p(y);
 ...
 */ function nr(t, e, n, r) {
    return void 0 === r && (r = !1), rr(n, t.ft(r ? 4 /* UserDataSource.ArrayArgument */ : 3 /* UserDataSource.Argument */ , e));
}
 ...
 */ function rr(t, e) {
    ...
    return function(t, e) {
        ...
        if (!zn(e.nt)) throw e.ct("".concat(t._methodName, "() can only be used with update() and set()"));
    ...
    return function(t, e) {
        ...
        throw e.ct("Unsupported field value: ".concat(st(t)));
    }(t, e);
}
...
function or(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof Dt || t instanceof jn || t instanceof Rn || t instanceof Pn || t instanceof Ln);
}
 ...
 */ function ur(t, e, n) {
    ...
    // FieldPath.
    (e = p(e)) instanceof xn) return e._internalPath;
 ...
 */ function cr(t, e, n) {
    ...
    /* path= */ void 0, n);
    try {
        return (new (xn.bind.apply(xn, r([ void 0 ], e.split("."), !1))))._internalPath;
    } catch (r) {
 ...
 */
function yr(t, e) {
    return t = p(t), e = p(e), t instanceof hr && e instanceof hr ? t._firestore === e._firestore && t._key.isEqual(e._key) && (null === t._document ? null === e._document : t._document.isEqual(e._document)) && t._converter === e._converter : t instanceof dr && e instanceof dr && qn(t.query, e.query) && St(t.docs, e.docs, yr)
    /**
 * Helper that calls `fromDotSeparatedString()` but wraps any error thrown.
 */;
}
...
function mr(t, e) {
    return "string" == typeof e ? cr(t, e) : e instanceof xn ? e._internalPath : e._delegate._internalPath;
}
 ...
 */ var _r = /** @class */ function(e) {
    ...
    return t(n, e), n._create = function(t, e, r) {
        ...
        var e = Qn(t.firestore), n = function(t, e, n, r, i, o, a) {
            ...
            } else "in" /* Operator.IN */ !== o && "not-in" /* Operator.NOT_IN */ !== o && "array-contains-any" /* Operator.ARRAY_CONTAINS_ANY */ !== o || Lr(a, o), 
            u = nr(n, e, a, 
...
/** Helper function to create a bound from a document or fields */ function xr(t, e, n, r) {
    if (n[0] = p(n[0]), n[0] instanceof hr) return function(t, e, n, r, i) {
        ...
        for (var o = [], a = 0, u = Ie(t); a < u.length; a++) {
            ...
            if (s.field.isKeyField()) o.push(zt(e, r.key)); else {
                ...
                if (qt(c)) throw new B(V, 'Invalid query. You are trying to start or end a query using a document for which the field "' + s.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === c) {
    ...
    return function(t, e, n, r, i, o) {
        ...
        if (i.length > a.length) throw new B(V, "Too many arguments provided to ".concat(r, "(). The number of arguments must be less than or equal to the number of orderBy() clauses"));
        for (var u = [], s = 0; s < i.length; s++) {
            ...
            if (a[s].field.isKeyField()) {
                ...
                if (!ke(t) && -1 !== c.indexOf("/")) throw new B(V, "Invalid query. When querying a collection and ordering by documentId(), the value passed to ".concat(r, "() must be a plain document ID, but '").concat(c, "' contains a slash."));
...
function Cr(t, e, n) {
    if ("string" == typeof (n = p(n))) {
        ...
        if (!ke(e) && -1 !== n.indexOf("/")) throw new B(V, "Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '".concat(n, "' contains a '/' character."));
    ...
    if (n instanceof Pn) return zt(t, n._key);
 ...
 * document contents.
 */ function Kr(t) {
    var e = gn((t = ct(t, Pn)).firestore), n = new zr(t.firestore);
    ...
    return function(t, r) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return e = A(t), i = rn(e.serializer, Ae(r)), [ 4 /*yield*/ , e.g("RunQuery", i.parent, {
                  ...
                  case 1:
                    return [ 2 /*return*/ , n.sent().filter((function(t) {
                        ...
                        return function(t, e, n) {
                            var r = Ze(t, e.name), i = Je(e.updateTime), o = e.createTime ? Je(e.createTime) : fe.min(), a = new ge({
                                mapValue: {
                                    fields: e.fields
                                }
...
function Qr(t, e, n) {
    var r = Br((t = ct(t, Pn)).converter, e, n), i = Wn(Qn(t.firestore), "setDoc", t._key, r, null !== t.converter, n);
    return yn(gn(t.firestore), [ i.toMutation(t._key, Ce.none()) ]);
}

function Wr(t, e, n) {
    for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
    var o, a = Qn((t = ct(t, Pn)).firestore);
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
        return o = "string" == typeof (e = p(e)) || e instanceof xn ? er(a, "updateDoc", t._key, e, n, r) : tr(a, "updateDoc", t._key, e), 
    yn(gn(t.firestore), [ o.toMutation(t._key, Ce.exists(!0)) ]);
}
 ...
 */ function Yr(t) {
    return yn(gn((t = ct(t, Pn)).firestore), [ new Ue(t._key, Ce.none()) ]);
}
 ...
 */ function Hr(t, e) {
    var n = Nn(t = ct(t, Fn)), r = Br(t.converter, e), i = Wn(Qn(t.firestore), "addDoc", n._key, r, null !== n.converter, {});
    return yn(gn(t.firestore), [ i.toMutation(n._key, Ce.exists(!1)) ]).then((function() {
        return n;
    }));
}
                ...
                switch (n.label) {
                  case 0:
                    return o = A(t), a = function(t, e, n) {
                        var r = rn(t, e), i = {}, o = [], a = 0;
                        return n.forEach((function(t) {
                            // Map all client-side aliases to a unique short-form
                            // alias. This avoids issues with client-side aliases that
                            // exceed the 1500-byte string size limit.
                            var e = "aggregate_" + a++;
                            i[e] = t.alias, "count" === t.D ? o.push({
                                alias: e,
                                count: {}
                            }) : "avg" === t.D ? o.push({
                                alias: e,
                        ...
                        e.$ = Pe(e, t.explicitOrderBy)), e.$;
                    }(r), i), u = a.request, s = a.et, c = u.parent, o.connection.P || delete u.parent, 
 ...
 */ var si = /** @class */ function() {
    ...
    return t.prototype.set = function(t, e, n) {
        ...
        var r = ci(t, this._firestore), i = Br(r.converter, e, n), o = Wn(this._dataReader, "WriteBatch.set", r._key, i, null !== r.converter, n);
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = p(e)) || e instanceof xn ? er(this._dataReader, "WriteBatch.update", a._key, e, n, r) : tr(this._dataReader, "WriteBatch.update", a._key, e), 
 ...
 */ var fi = /** @class */ function() {
    ...
    function t(t, e, n, r, i) {
        ...
        this.deferred = i, this.Tt = n.maxAttempts, this.Pt = new pn(this.asyncQueue, "transaction_retry" /* TimerId.TransactionRetry */)
    ...
    return t.prototype.run = function() {
        ...
        this.Pt.J((function() {
            return e(t, void 0, void 0, (function() {
                var t, e, r = this;
                return n(this, (function(n) {
                    return t = new fi(this.datastore), (e = this.It(t)) && e.then((function(e) {
        ...
        var e = this;
        this.Tt > 0 && this.yt(t) ? (this.Tt -= 1, this.asyncQueue.enqueueAndForget((function() {
 ...
 */ var yi, mi = /** @class */ function() {
    ...
    function t() {
        ...
        this.Pt = new pn(this, "async_queue_retry" /* TimerId.AsyncQueueRetry */), 
        // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.Nt = function() {
            var e = di();
            e && b("AsyncQueue", "Visibility state changed to " + e.visibilityState), t.Pt.Z();
        };
        var e = di();
        e && "function" == typeof e.addEventListener && e.addEventListener("visibilitychange", this.Nt);
    }
    ...
    t.prototype.enqueueAndForget = function(t) {
        ...
        return this.qt((function() {
            return e.Ft && e.Ct ? Promise.resolve() : (t().then(n.resolve, n.reject), n.promise);
        })).then((function() {
            return n.promise;
        }));
    ...
    t.prototype.Bt = function() {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (0 === this.gt.length) return [ 3 /*break*/ , 5 ];
                    n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , this.gt[0]() ];

                  case 2:
                    return n.sent(), this.gt.shift(), this.Pt.reset(), [ 3 /*break*/ , 4 ];
        ...
        var e = this, n = this.wt.then((function() {
            return e.bt = !0, t().catch((function(t) {
                e.Dt = t, e.bt = !1;
                var n = 
                /**
 ...
 */
    ...
    t.prototype.Qt = function() {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return [ 4 /*yield*/ , t = this.wt ];

                  case 1:
                    e.sent(), e.label = 2;

                  case 2:
                    if (t !== this.wt) return [ 3 /*break*/ , 0 ];
                    e.label = 3;
     ...
     */
    t.prototype.Lt = function(t) {
        for (var e = 0, n = this.vt; e < n.length; e++) {
    ...
    t.prototype.Mt = function(t) {
        ...
        // Note that draining may generate more delayed ops, so we do that first.
            ...
            e.vt.sort((function(t, e) {
                return t.targetTimeMs - e.targetTimeMs;
            }));
            for (var n = 0, r = e.vt; n < r.length; n++) {
                var i = r[n];
    ...
    /** Called once a DelayedOperation is run or canceled. */ t.prototype.$t = function(t) {
    ...
    return t.prototype.get = function(t) {
        ...
        var r = ci(t, this._firestore), i = Br(r.converter, e, n), o = Wn(this._dataReader, "Transaction.set", r._key, i, null !== r.converter, n);
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = p(e)) || e instanceof xn ? er(this._dataReader, "Transaction.update", a._key, e, n, r) : tr(this._dataReader, "Transaction.update", a._key, e), 
...
yi = "".concat(i, "_lite"), g = yi, o(new c("firestore/lite", (function(t, e) {
    var n = e.instanceIdentifier, r = e.options, i = t.getProvider("app").getImmediate(), o = new _n(new W(t.getProvider("auth-internal")), new X(t.getProvider("app-check-internal")), function(t, e) {
